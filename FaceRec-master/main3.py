...
#     vs = cv2.VideoCapture("D:/Видео/Project/20200217085400-20200217130000/s3.mp4"); #get input from webcam
...
#         bbox, label, conf = cv.detect_common_objects(vs)
#         output_image = draw_bbox(vs, bbox, label, conf)

#         output_vid = draw_bbox(vs, bbox, label, conf)
...
#     :param positions: a list of face position typse of all faces on screen
